...
def attack(char_name: str, char_class: str) -> str:
    """Return of the damage caused by the player."""
...
def defence(char_name: str, char_class: str) -> str:
    """Return of the description of shock blocking."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Return of the special skills and their damage."""
    if char_class == 'warrior':
        return (
...
def choice_char_class() -> str:
    """Player choice of character type - warrior, mage, healer."""
